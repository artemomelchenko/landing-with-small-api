...
<div class="header_heading_content">
    <div class="heading_flex_container">
        ...
        <a class="btn_header modal" href="#">замовити</a>
    </div>
            ...
            <div class="brand-info">
                <div class="brand-description">
                    ...
                    <div class="slider-wrap">
                        <div class="brand-carusel"></div>
                    </div>
                    <div class="items-price"><span class="price-title">Ціна</span> від <span class="price">199</span>
                    </div>
        ...
        <div class="calculator_grid_container grid">
            ...
            <div class="content_form">
                <div class="form_calculator">
                    <svg class="up_svg_second" width="130" height="43" viewBox="0 0 130 43" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        <path d="M96.5 20L116 0L130 20H96.5Z" fill="#7A010A"/>
                        <path d="M116 0H41.0786L0 43H74.9214L116 0Z" fill="url(#paint0_linear_up_second)"/>
                        <defs>
                            <linearGradient id="paint0_linear_up_second" x1="58" y1="0" x2="58" y2="43"
                                            gradientUnits="userSpaceOnUse">
                                <stop offset="1" stop-color="#FA0105"/>
                                <stop offset="1" stop-color="#FF3336"/>
                            </linearGradient>
                    ...
                    <div class="wrapper_form">
                        ...
                        <div class="form_field full_width">
                            ...
                            <input type="text" id="Second_name" name="name" value="" minlength="2" required
                                   class='fName'>
                        </div>
                        <div class="form_field full_width">
                        ...
                        <div class="form_field full_width">
                            <button class="btn_product" type="submit"><span class="dn">отримати</span> розрахунок
                            </button>
                        </div>
                        <?= Html::endForm() ?>
                    ...
                    <svg class="down_svg_second" width="124" height="43" viewBox="0 0 124 43" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.5 32L8.00002 43L0.499999 32L18.5 32Z" fill="#7A010A"/>
                        <path d="M8 43H82.9214L124 0H49.0786L8 43Z" fill="url(#paint0_linear_down_second)"/>
                        <defs>
                            <linearGradient id="paint0_linear_down_second" x1="66" y1="43" x2="66" y2="0"
                                            gradientUnits="userSpaceOnUse">
                                <stop offset="1" stop-color="#FA0105"/>
                                <stop offset="1" stop-color="#FF3336"/>
                            </linearGradient>
